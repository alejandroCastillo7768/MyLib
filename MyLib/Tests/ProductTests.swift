...
//  ModelsModule_Tests
//
//  Created by Alejandro Castillo on 13/08/2021.
...
class ProductTests: XCTestCase {
    ...
    func testPropertiesFromProduct() {
        XCTAssert(product.id != nil)
        XCTAssert(product.title != nil)
        XCTAssert(product.image != nil)
    }
